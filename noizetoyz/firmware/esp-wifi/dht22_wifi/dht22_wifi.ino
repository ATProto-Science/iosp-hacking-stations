/*  Live Data Streaming/Noizetoyz crossover — DHT22 over WiFi (Wemos D1 mini), temperature +
    humidity. Same shape as ../bmp180_wifi/bmp180_wifi.ino (a second sensor
    board feeding live-data/wifi_sensor_relay.py, not another
    synth relay) — copied structurally rather than re-derived:
    ...
    floating-point type, see live-data's own "no floats" note):
