"""Station 2: direct ATProto session helpers for wifi_sensor_relay.py, no nebra.

Real problem hit 2026-09-04: nebra requires Python 3.11+, which robopi (the
box actually running this relay, per station-5-synth/README.md's "Workshop
...
package-juggling gets through. station-5-synth/relay/synth_relay.py already
