#!/usr/bin/env python3
"""Station 2 skeleton: WiFi sensor relay — a BMP180-over-WiFi ESP8266 -> ATProto.
...
to ATProto — same shape as station-5-synth's synth_relay.py (a networked
device -> one small Python relay -> ATProto), pointed at this station's
science.iosp.sensor.reading collection instead of station 5's synth notes.
...
(../station-5-synth/firmware/esp-wifi/bmp180_wifi/): one line per reading,
