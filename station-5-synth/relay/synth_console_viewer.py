#!/usr/bin/env python3
"""Station 5 skeleton: console viewer — watches music.atproto.synth.note over
...
file's docstring for the verified detail). Point webapp/index.html's live
feed at the same HappyView AppView instead of this for the browser UI; this
is the plain terminal proof that the read side works.
"""
...
COLLECTION = "music.atproto.synth.note"
